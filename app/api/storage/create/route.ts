...
export async function GET() {
  try {
    ...
    const minecraftBucket = buckets?.find((bucket) => bucket.name === "minecraft-forum")
    ...
    return NextResponse.json({
      ...
      minecraftForumExists: !!minecraftBucket,
      minecraftForumBucket: minecraftBucket
        ? {
            name: minecraftBucket.name,
            public: minecraftBucket.public,
            createdAt: minecraftBucket.created_at,
            updatedAt: minecraftBucket.updated_at,
          }
        : null,
    })
  } catch (error: any) {
